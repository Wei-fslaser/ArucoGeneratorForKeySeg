...
c.rect((page_width - card_width) / 2, (page_height - card_height) / 2, card_width, card_height, stroke=True, fill=False)
c.drawImage(tempFilename, (page_width - card_width) / 2, (page_height - card_height) / 2, card_width, card_height)
c.showPage()
c.save()

# Save the PDF
outputFilename = "aruco_letter_size.pdf"
